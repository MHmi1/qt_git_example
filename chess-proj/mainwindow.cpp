...
void MainWindow::on_start_clicked()
{
    ...
    window->show();
    connect(button, &QPushButton::clicked, this,[=](){ MainWindow::g(p1_name->text(),p2_name->text(),game_name->text()); }); //lambda experssion
}
...
void MainWindow::g(QString a, QString b, QString c)
{
    ui->game_label2->setText(c);
     ui->p1_name->setText(a);
    ui->p2_name->setText(b);
